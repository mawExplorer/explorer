- view: fact_linkclick_daily
  ...
  - dimension: link_category
    sql: ${TABLE}.link_category

  - dimension: link_element
    sql: ${TABLE}.link_element

  - dimension: link_position
    sql: ${TABLE}.link_position
